...
class CNN_BiLSTM_custom_pooling_2_poisson(Model):
    def __init__(self):
        ...
        self.conv1 = Conv1D(filters=100, kernel_size=8, activation='relu', padding='same') #  75 12
        self.drop1 = Dropout(0.2)
        self.conv2 = Conv1D(filters=200, kernel_size=8, activation='relu', padding='same') #  150 6
